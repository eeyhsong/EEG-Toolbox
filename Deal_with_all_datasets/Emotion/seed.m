% used for preprocessed the SEED datasets
...
file_list = load('namefile_list.mat');
file_list = file_list.namefile_list;
short_name = load('short_name.mat');
short_name = short_name.short_name;
label = load('.\SEED\Preprocessed_EEG\label.mat');
fc = 200;
Wl = 4; Wh = 47; % 
Wn = [Wl*2 Wh*2]/fc;
[b,a]=cheby2(6,60,Wn);
for i = 1:15 % subject
    for j = 1:3 % session
        ...
        file_path = strcat('.\SEED\Preprocessed_EEG\',file_pre,'.mat');
        ...
        for k = 1:15 % trial
            ...
            saveDir = strcat('.\SEED\seed_seed\data\S',num2str(i),'_',num2str(j),'_',num2str(k),'.mat');
